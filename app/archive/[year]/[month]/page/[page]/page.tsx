...
interface ArchiveYearMonthPaginationPageProps {
  params: Promise<{ year: string; month: string; page: string }>;
}

export default async function ArchiveYearMonthPaginationPage({
  params,
}: ArchiveYearMonthPaginationPageProps) {
    ...
    <div className="container mx-auto px-4 py-12">
      <section className="mb-12">
        <h1 className="text-3xl font-bold mb-4">
          {yearNum}年{monthNames[monthNum - 1]}の記事 (ページ {pageNum})
        </h1>
